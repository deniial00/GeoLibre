...
function getArcGISMatrixViewState(view, longitude, latitude, zoom, resolution, altitude) {
  return {
            ...
            if (gl) {
              ...
              initializeResources
                ...
                .then((resources) => {
                  ...
                  self.deck.toJSON().onDeviceInitialized?.(resources.model.device);
